  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 ">
        <img src={logo} alt="examgenius" className="w-9 h-9 " />
          ...
          <AnimatePresence>
            {showCredits && (
              <motion.div
                ...
                className="absolute -right-12.5 mt-4 w-64 bg-black/90 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.75)]  border border-white/10 rounded-2xl p-4 text-white  "
              >
          ...
          <AnimatePresence>
            {showProfile && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10, scale: 0.95 }}
                transition={{ duration: 0.2 }}
                className="absolute right-0 mt-4 w-52 bg-black/90 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.75)]  border border-white/10 rounded-2xl p-4 text-white  "
              >
                <MenuItem
                  text="History"
